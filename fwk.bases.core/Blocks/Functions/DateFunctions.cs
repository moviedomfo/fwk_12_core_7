...
{
    public class InterseccionTable
    {
        public DateTime Dr { get; set; }
        public DateTime Hr { get; set; }
        public Boolean Interseccion { get; set; }
    }
/// <summary>
...
public class DateFunctions
    {
        ...
        public static InterseccionTable Interseccion(DateTime D1, DateTime H1, DateTime D2, DateTime H2)
        {
            ...
            //List<InterseccionTable> wDtt = new List<HelperFunctions.InterseccionTable>();
            InterseccionTable item = new  InterseccionTable ();
            item.Dr = Dr;
            item.Hr = Hr;
            item.Interseccion = wInterseccion;
            //wDtt.Add(item);
            return item;
        }
