...
namespace Fwk.Bases
{
    ...
    public  class Entities<T> : List<T>, Fwk.Bases.IEntity where T : Entity
    {
        ...
        {
            return (TEntities)Fwk.HelperFunctions.SerializationFunctions.DeserializeFromXml(this.GetType(), this.GetXml());
        }
        /// <summary>
